...
public class Roi extends Piece{
	...
	public Roi(int couleur, Plateau plateau) {
		super(couleur, plateau);
		setName("roi");
	}
	
	public Roi(int id, int joueur, String type, int level, int exp ,int pv, int strength, int inte, String rarete, Plateau plateau){
		super(id, joueur, type, level, exp ,pv, strength, inte, rarete,plateau);
		setName("roi");
	}
	
	public Roi(int id, int joueur, String type, int level, int exp ,int pv, int strength, int inte, String rarete){
